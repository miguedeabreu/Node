const Proffesional = require ('../Back/classPro');
...
app.post('/profesionales', function (req, res){
    ...
    let profesional = new Proffesional (name, age, genre, weight, height);
...
app.put('/profesionales', function (req, res){    
    ...
    if (profesionales.length <= id){
        ...
        respuesta = {error: false, message: "Introducir un ID para poder modificar."};
    }
    else {
...
app.delete('/profesionales', function (req, res){
    ...
    if (profesionales.length > id) {
        ...
        respuesta = {error: false, message: "Profesional eliminado correctamente."};
    }
    else {
        respuesta = {error: true, message: "No ha eliminado ningún profesional."};
    }
    res.send(respuesta);
});
